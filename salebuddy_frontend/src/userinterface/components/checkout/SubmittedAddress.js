...
export default function SubmittedAddress({ userAddress }) {
                    ...
                    <div style={{ width: sm ? '100%' : '49%', height: sm ? 160 : '100%', background: '#ffffff', borderRadius: 10, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <div style={{ width: '90%', height: '90%' }}>
                            ...
                            <div style={{ width: '100%', height: '40%', display: 'flex', flexDirection: 'column' }}>
                                <div style={{ width: '100%', height: '33.3%' }}>{item?.address},{item.area}</div>
                                <div style={{ width: '100%', height: '33.3%' }}>Near {item?.landmark},{item.pincode}</div>
                                <div style={{ width: '100%', height: '33.3%' }}>{item.city} {item.state}</div>
                                <div style={{ width: '100%', height: '33.3%' }}>Mobile No:{item.mobileno}</div>
                            </div>
