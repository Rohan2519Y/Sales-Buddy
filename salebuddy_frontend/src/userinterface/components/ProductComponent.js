...
export default function ProductComponent() {
    var data = [{
        ...
        image: '1ee1673c-4cac-4d62-aba2-bd9d577b3b09.png', ratings: 3.3, price: 78000.00, offer: 70000.00
    }]
                    ...
                    {data.map((item) => (
                        <div style={{ height: 370, width: 220, background: ' black', margin: 30, borderRadius: 10, display: "flex", justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <div style={{ width: '95%', height: '30%', alignItems: 'center', display: 'flex', flexDirection: 'column', marginBottom: '5%' }}>
                                ...
                                <div style={{ width: '90%', height: '50%', color: 'white', display: 'flex' }}>
                                    <div style={{ fontSize: 22, fontWeight: 600 }}>{'\u20B9'}{item.price.toFixed(2)}</div>
                                    <div style={{ fontSize: 17, fontWeight: 400, color: 'grey' }}><s>{'\u20B9'}{item.offer.toFixed(2)}</s></div>
                                </div>
