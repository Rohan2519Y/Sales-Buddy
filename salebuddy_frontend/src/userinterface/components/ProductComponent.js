...
export default function ProductComponent({ item, i }) {
    ...
    return (<>
        <div style={{ height: smatches ? 270 : matches ? 330 : 370, width: '100%', background: ' black', marginLeft: '3.5%', marginRight: '3.5%', borderRadius: 10, display: "flex", justifyContent: 'center', flexDirection: 'column', alignItems: 'center', fontFamily: '"Inter", sans-serif' }}>
            ...
            <div style={{ width: '95%', height: '30%', alignItems: 'center', display: 'flex', flexDirection: 'column', marginBottom: '5%' }}>
                <div style={{ width: '90%', height:smatches?'75%': matches ? '55%' : '50%', color: 'white', justifyContent: 'center', marginBottom: '2%', fontSize: smatches ? '90%' : matches ? '100%' : '115%', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden', textOverflow: 'ellipsis', lineHeight: '1.2' }}>{item.productname}...</div>
