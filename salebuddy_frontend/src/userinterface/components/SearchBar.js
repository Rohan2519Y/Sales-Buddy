...
export default function SearchBar() {
    ...
    return (
        <div style={{marginBottom:5 , width: matches?'90%':'50%', display: 'flex', alignItems: 'center',justifyContent:matches?'center':'' }}>
            <div style={{ width: matches?'100%':"70%", height: matches?'6.5vh':'6vh', background: 'white', display: 'flex', alignItems: 'center', justifyContent: "space-evenly", border: '1px solid black', borderRadius: 5, marginLeft: matches?0:'8%',marginTop:5 }}>
