        ...
        <div style={{ width: '70%', height: '80%', }}>
          <div style={{ width: '100%', height: '15%', border: '2px solid #353535', borderRadius: 3, display: 'flex', justifyContent: 'space-evenly' }}>
            ...
            <div style={{ width: '8%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ width: '100%', height: '50%', border: '2px solid #999999', borderRadius: 3, display: 'flex', justifyContent: 'center', alignItems: 'center', color: ' #ffffff', fontSize: '85%' }}>OR</div>
              <div style={{ width: 2, height: '25%', background: ' #999999' }}></div>
            </div>
          ...
          <div style={{ width: '100%', height: '15%', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '80%', color: ' #ffffff' }}>
