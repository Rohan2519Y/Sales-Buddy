        ...
        <div style={{ width: '100%', height: '100%', background: ' #191919', fontFamily: '"Inter", sans-serif' }}>
            ...
            <div style={{ width: '100%', height: '100vh', display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                ...
                <div style={{ width: '45%', height: 105, display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', width: '50%', height: errorF ? 112 : 90, alignItems: 'flex-end' }}>
                        <div style={{ width: '97%', fontSize: '100%', height: 38, marginBottom: 'auto', color: ' #ffffff', display: 'flex', alignItems: 'center' }}>First Name</div>
                        <div style={{ width: '97%', height: 55, background: ' #f6f6f6', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: 8, border: errorF ? '1px solid red' : '1px solid #f6f6f6' }}>
                        ...
                        {errorF && (
                            <Typography sx={{ width: '97%', fontSize: '90%', color: '#f44336', }} >
                                {errorF}
                            </Typography>
                        )}
                    </div>
                ...
                <div style={{ width: '45%', height: 105, display: 'flex', justifyContent: 'space-between', marginTop: 15 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', width: '50%', height: 90 }}>
                        <div style={{ width: '97%', fontSize: '100%', height: 38, marginBottom: 'auto', color: ' #ffffff', display: 'flex', alignItems: 'center' }}>Middle Name</div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', width: '50%', height: errorL ? 112 : 90, alignItems: 'flex-end' }}>
                        <div style={{ width: '97%', fontSize: '100%', height: 38, marginBottom: 'auto', color: ' #ffffff', display: 'flex', alignItems: 'center' }}>Last Name</div>
                        <div style={{ width: '97%', height: 55, background: ' #f6f6f6', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: 8, border: errorL ? '1px solid red' : '1px solid #f6f6f6' }}>
                ...
                <div style={{ width: '45%', height: 50, display: 'flex', justifyContent: 'space-between' }}>
