...
export default function ApplyCoupon(){
    return(<>
        <div style={{display:'flex',width:'100%',justifyContent:'flex-end',marginBottom:20}}>
            <div style={{display:'flex',width:'80%',height:70,justifyContent:'space-between',alignItems:'center',paddingRight:10,paddingLeft:10,background:' #ffffff',borderRadius:5}}>
