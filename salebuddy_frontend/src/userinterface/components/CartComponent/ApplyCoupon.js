...
export default function ApplyCoupon() {
    ...
    return (<>
        <div style={{ display: 'flex', width: '100%', justifyContent: matches?'center':'flex-end', marginBottom: 30 }}>
            <div style={{ display: 'flex', width: matches?'95%':'80%', height: 70, justifyContent: 'space-between', alignItems: 'center', paddingRight: 30, paddingLeft: 30, background: ' #ffffff', borderRadius: 5, boxSizing: 'border-box' }}>
